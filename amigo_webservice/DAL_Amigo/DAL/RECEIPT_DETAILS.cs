...
namespace DAL_AmigoProcess.DAL
{
    ...
    public class RECEIPT_DETAILS
    {
        ...
        string strUpdateReceipt_Detail = @"UPDATE [dbo].[RECEIPT_DETAILS]
                                            ...
                                            WHERE SEQ_NO = @SEQ_NO";
        string str_Update_Payment_Day = @"UPDATE[dbo].[RECEIPT_DETAILS]
                                            SET 
                                            PAYMENT_DAY = @PAYMENT_DAY
                                            WHERE SEQ_NO = @SEQ_NO";
        ...
        string strConvertFromNonAmigoToAmigo = @"INSERT INTO RECEIPT_DETAILS
                                                ...
                                                FROM [dbo].[RECEIPT_DETAILS_NON_AMIGO]
                                                WHERE [SEQ_NO] = @SeqNo";
        ...
        string strRefundAllocation = @"UPDATE [dbo].[RECEIPT_DETAILS]
                                    SET RUN_RESULT = 31
                                    WHERE SEQ_NO = @SEQ_NO";
